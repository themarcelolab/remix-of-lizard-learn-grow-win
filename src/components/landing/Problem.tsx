...
const Problem = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Cada palavra reaparece exatamente quando você está prestes a esquecê-la.",
      color: "lizard-orange",
    ...
    },
    {
      ...
      description: "Sem listas aleatórias – evolução mensurável e consistente.",
      color: "lizard-green",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter">
            A <span className="gradient-lilac-text">ciência</span> por trás do seu progresso
          </h2>
